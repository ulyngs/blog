...
````markdown
(...) appearing as a playable track for Guitar Hero Live.(Hume 1748)
````
...
```markdown
(...) appearing as a playable track for Guitar Hero Live.\citep{Hume1748}
```
...
````markdown
`r ''````{r two-col-tribute-plot, echo=FALSE, out.width='0.98\\textwidth', fig.cap="This is a two-column plot of how great Tribute gets over time", fig.env='figure*'}
