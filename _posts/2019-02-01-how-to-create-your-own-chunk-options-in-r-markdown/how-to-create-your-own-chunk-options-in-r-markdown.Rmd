...
description: |
  What to do when the chunk options you need to get R Markdown to do what you want is missing? You create the ones you need. It is incredibly useful to be able to do so --- unfortunately it can also be tricky to figure out how. Here's a quick guide.
author:
  - name: Ulrik Lyngs
